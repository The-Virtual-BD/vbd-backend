        ...
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="FFFFFF"
            ...
            <tr>
                <td style="padding: 20px; text-align: center;" class="bg-blue">
                    ...
                    <h1 style="color: #ffffff" class="text-white font-raleway uppercase font-bold">Reset Password</h1>
                </td>
            </tr>

            <tr>
                <td>
                    <p>You recently requested to reset your password for our application. Click the button below to reset it.</p>
                    <a href="{{ url('/api/tokenfrontend?token=' . $token) }}" style="display: inline-block; background-color: #3490dc; color: #fff; padding: 10px 20px; text-decoration: none;">Reset Password</a>
