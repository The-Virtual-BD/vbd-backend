        ...
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="FFFFFF"
            ...
            <tr>
                <td style="padding: 20px; text-align: center;" class="bg-blue">
                    <h1 style="color: #ffffff" class="text-white font-raleway uppercase font-bold">Subscribing to VirtualBD</h1>
                </td>
            </tr>
            ...
            <tr style="background-color: #ffffff;">
                <td style="padding:20px;">
                    ...
                    <center>
                        <a href="https://www.thevirtualbd.com" target="_blank" style="display: inline-block; background-color: #3490dc; color: #fff; padding: 10px 20px; text-decoration: none;">Visit</a>
                    </center>
                </td>
            </tr>
