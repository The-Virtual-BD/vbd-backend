...
</head <body style="background: #eeeeee; padding: 10px; font-family: 'Open Sans', sans-serif, Helvetica, Arial;">
<center>
    <!-- ** Table begins here
    ----------------------------------->
        ...
        <tr style="background-color: #ffffff;">
            <td style="padding:20px;">
                <div style="margin-bottom: 20px;">
                    <p>Welcome to the VirtualBD. Your account has been created.</p>
                </div>
                <center>
                    <a href="https://www.thevirtualbd.com" target="_blank"
                        style="display: inline-block; background-color: #3490dc; color: #fff; padding: 10px 20px; text-decoration: none;">Visit</a>
                </center>
            </td>
        </tr>
